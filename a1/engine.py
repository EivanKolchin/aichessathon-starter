"""Experimental entrypoint with original compiled search and the A0 clock policy."""
...
from a1.search import Search, warmup

# No disk compilation cache. Every new game compiles before the playing clock.
warmup()
